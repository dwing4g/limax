...
local function main()
  ...
  limaxctx.auanyservice.temporary("127.0.0.1", 8181, appId, "abc", "123456", "test", "machine identity", 5000, USAGE_LOGIN, "", 10000,
  ...
  if nil ~= credential then
    ...
    local config = { serverip = "127.0.0.1", serverport = 10000, username = credential, token = "machine identity", platflag = "temporary", script = cbvars,
